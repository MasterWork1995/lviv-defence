export const panelCard =
  "rounded-lg border border-border/60 bg-bg/96 p-4 backdrop-blur-md";

export const panelSectionTitle =
  "font-display text-[11px] font-semibold uppercase tracking-[0.22em] text-text lg:text-[12px] lg:tracking-[0.28em]";

export const panelSubLabel =
